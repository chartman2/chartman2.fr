...
Traefik est un reverse proxy open-source conçu pour gérer les trafics HTTP et HTTPS vers des applications Docker. 

Il permet de router les requêtes vers les conteneurs Docker appropriés, ainsi que d'apporter des fonctionnalités telles que l'équilibrage de charge, la mise en réserve, le SSL/TLS et la surveillance.

Cet article sera complété au fur et à mesure.

Pour l'utilisation avec le projet [Todo-list](/blog/article/1-to-do-list-initialisation), nous pouvons construire Traefik comme cela :
