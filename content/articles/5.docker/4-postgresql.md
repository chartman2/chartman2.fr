...
Créé en 1986 par l'Université de Californie à Berkeley, PostgreSQL a grandi avec la communauté open-source. Aujourd'hui, il s'impose comme l'un des systèmes de gestion de bases de données (SGBD) les plus populaires du marché.
